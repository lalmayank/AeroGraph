"""
python/aerograph-otel/src/aerograph_otel/constants.py

All AeroGraph-specific OTel attribute key string constants.
Mirrors AEROGRAPH_ATTRS in TypeScript (constants.ts) exactly.

Usage:
    from aerograph_otel.constants import AeroGraphAttrs
    attrs = [{"key": AeroGraphAttrs.KIND, "value": {"stringValue": "prompt"}}]
"""


class AeroGraphAttrs:
    """Namespace class for all aerograph.* OTel attribute key constants."""
